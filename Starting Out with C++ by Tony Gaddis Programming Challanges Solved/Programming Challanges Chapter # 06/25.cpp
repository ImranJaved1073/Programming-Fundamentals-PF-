...
void getDepartureAndArrivalTimes(double &departure_time, double &arrival_time)
{
    cout << "\nWhat is the time of departure" << endl
         << "on the first day of the trip? " << endl
         << endl
...
void getParkingFees(int total_days_on_trip, double &total_expenses, double &total_allowable_expenses,
                    double &total_reimbursement, double &total_amount_saved)
{
...
void getTaxiFees(int total_days_on_trip, double &total_expenses, double &total_allowable_expenses,
                 double &total_reimbursement, double &total_amount_saved)
{
...
void getHotelFees(int total_days_on_trip, double &total_expenses, double &total_allowable_expenses,
                  double &total_reimbursement, double &total_amount_saved)
{
...
void getMealFees(double &total_expenses, double departure_time,
                 double &total_allowable_expenses, double &total_reimbursement,
                 double &total_amount_saved, double arrival_time)
{
...
void displayTotals(int total_days_on_trip, double departure_time, double arrival_time,
                   double total_expenses, double total_allowable_expenses,
                   double total_reimbursement, double total_amount_saved)
{
